...
Select only the audit domains relevant to this application. Do not blindly run every possible check. Reason about which domains matter and state the scope before investigating.
